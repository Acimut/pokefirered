    ...
    *(&gBattleStruct->stringMoveType) = sBattleMsgDataPtr->moveType;
    ...
    case STRINGID_INTROMSG: // first battle msg
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        {
            ...
            {
                STRINGPTR_RESULT(sText_Trainer1WantsToBattle)
            }
        }
        else
        {
        ...
        else
        {
            if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE)
            {
                if (gBattleTypeFlags & BATTLE_TYPE_MULTI)
                    ...
                    STRINGPTR_RESULT(sText_Trainer1SentOutTwoPkmn)
            }
            else
            {
                if (gBattleTypeFlags & BATTLE_TYPE_LINK)
                {
                    ...
                    STRINGPTR_RESULT(sText_Trainer1SentOutPkmn)
            }
        }
        break;
    case STRINGID_RETURNMON: // sending poke to ball msg
        ...
        else
        {
            ...
            {
                STRINGPTR_RESULT(sText_Trainer1WithdrewPkmn)
            }
        }
        break;
    case STRINGID_SWITCHINMON: // switch-in msg
        ...
        else
        {
            ...
            {
                STRINGPTR_RESULT(sText_Trainer1SentOutPkmn2)
            }
        }
        break;
    ...
    default: // load a string from the table
        ...
        {
            STRINGPTR_RESULT(gBattleStringsTable[stringId - BATTLESTRINGS_TABLE_START])
        }
        break;
    }
